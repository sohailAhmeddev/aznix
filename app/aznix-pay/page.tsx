  ...
  return (
    <main className="bg-[#F5F2EF] text-slate-950">
      <section className="relative overflow-hidden">
        <div className="mx-auto grid max-w-7xl gap-16 px-6 pb-20 pt-28 lg:grid-cols-[1.1fr_0.9fr] lg:px-8 lg:pt-32">
          <div className="space-y-8">
            <div className="type-button inline-flex items-center gap-2 rounded-full bg-[#e8f5ee] px-4 py-2 text-[#1a6b4a]">
            ...
            <div className="flex flex-wrap items-center gap-4">
              <a href="#" className="type-button inline-flex rounded-full bg-[#14532d] px-6 py-3 text-white transition hover:bg-[#1f7d52]">
                Get Started
              </a>
              <a href="#" className="type-button inline-flex rounded-full border border-slate-300 bg-transparent px-6 py-3 text-slate-950 transition hover:border-[#1a6b4a] hover:text-[#1a6b4a]">
                Contact sales
              </a>
            </div>
            <div className="type-body flex flex-wrap items-center gap-3 text-slate-600">
          ...
          <div className="relative">
            ...
            <div className="rounded-[24px] border border-slate-200 bg-white p-8 shadow-[0_20px_60px_rgba(0,0,0,0.07)]">
              <div className="flex items-center justify-between gap-4 border-b border-slate-200 pb-6">
                <div className="type-body text-slate-500">My Account</div>
                <div className="type-button rounded-full bg-[#e8f5ee] px-3 py-1 text-[#1a6b4a]">
                  34 currencies
                </div>
              </div>
              <div className="mt-6 space-y-3">
                <div className="type-body text-slate-500">Total balance</div>
                <div className="text-4xl font-semibold text-slate-950">€84,250.00</div>
                <div className="type-body text-slate-500">Across 6 currencies</div>
              </div>
              <div className="mt-7 flex flex-wrap gap-2">
                {['🇬🇧 GBP', '🇺🇸 USD', '🇪🇺 EUR', '🇩🇰 DKK', '🇨🇦 CAD'].map((currency) => (
                  <div key={currency} className="type-button rounded-full border border-slate-200 bg-[#f5f2ef] px-3 py-2 text-slate-700">
                    {currency}
                  </div>
                ))}
              </div>
                ...
                {[
                  ...
                  <div key={txn.name} className="flex items-center justify-between rounded-2xl bg-[#f5f2ef] p-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="type-card-title text-slate-950">{txn.name}</div>
                        <div className="type-label normal-case tracking-normal text-slate-500">{txn.date}</div>
                      </div>
                    </div>
                    <div className={`type-button ${txn.tone}`}>{txn.amount}</div>
                  </div>
                ))}
              </div>
            </div>
      ...
      <section className="bg-[#14532d] py-10 text-white">
        <div className="type-button mx-auto flex max-w-7xl flex-wrap items-center justify-center gap-4 px-6 sm:px-8 lg:px-10">
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                <div key={item.label} className="border-r border-slate-200 last:border-r-0 px-4 text-center">
                  ...
                  <div className="type-body-muted mt-2">{item.label}</div>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-10">
          <div className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr]">
            <div>
              <div className="type-overline pb-2 text-[#1a6b4a]">Financial Services</div>
              <h2 className="type-section-title not-italic">Everything your business needs to pay globally</h2>
              <p className="type-body-lg mt-4 max-w-2xl text-slate-600">One account for all your international payment needs — from holding to sending, exchanging to receiving.</p>
            </div>
            <div className="grid gap-6 sm:grid-cols-2">
              {serviceCards.map((card) => (
                <div key={card.title} className={`rounded-[20px] border p-6 transition hover:-translate-y-1 hover:shadow-[0_12px_40px_rgba(0,0,0,0.08)] ${card.primary ? 'bg-[#14532d] border-transparent text-white' : 'bg-white border-slate-200 text-slate-950'}`}>
                  ...
                  <h3 className="type-card-title text-inherit">{card.title}</h3>
                  <p className={`type-body mt-3 ${card.primary ? 'text-slate-200' : 'text-slate-600'}`}>{card.body}</p>
                  <a href="#" className={`type-button mt-6 inline-flex items-center gap-2 ${card.primary ? 'text-white/80' : 'text-[#1a6b4a]'}`}>
      ...
      <section className="bg-white py-16">
        <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-10">
          <div className="grid gap-10 lg:grid-cols-[1.1fr_1fr] lg:items-start">
            <div>
              <div className="type-overline pb-2 text-[#1a6b4a]">Personalised Support</div>
              <h2 className="type-section-title not-italic">Say goodbye to generic help</h2>
              <p className="type-body-lg mt-4 text-slate-600">Hello to personalized service that’s all about you and your unique business needs. Your account manager is always available to help.</p>
              <div className="mt-8 flex flex-wrap gap-4">
                <a href="#" className="type-button inline-flex rounded-full bg-[#14532d] px-6 py-3 text-white transition hover:bg-[#1f7d52]">Get Started</a>
                <a href="#" className="type-button inline-flex rounded-full border border-slate-300 bg-transparent px-6 py-3 text-slate-950 transition hover:border-[#1a6b4a] hover:text-[#1a6b4a]">Contact sales</a>
              </div>
            </div>
              ...
              {supportFeatures.map((feature) => (
                <div key={feature.title} className="support-feat rounded-[16px] border border-slate-200 bg-[#f5f2ef] p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="type-card-title text-slate-950">{feature.title}</h4>
                      <p className="type-body-muted mt-2">{feature.description}</p>
                    </div>
                  </div>
                </div>
              ))}
      ...
      <section className="py-16">
        <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-10">
          <div className="pb-10">
            <div className="type-overline pb-2 text-[#1a6b4a]">Trusted Worldwide</div>
            <h2 className="type-section-title not-italic">Trusted by companies of all sizes</h2>
            <p className="type-body-lg mt-4 max-w-2xl text-slate-600">Aznix Pay has earned the trust of companies worldwide by tailoring services to the unique needs of each client.</p>
          </div>
          <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
            {testimonials.map((item) => (
              <div key={item.author} className="rounded-[20px] border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <p className="type-body mt-4 italic text-slate-700">“{item.quote}”</p>
                <div className="type-card-title mt-5 text-slate-950">{item.author}</div>
                <div className="type-label normal-case tracking-normal text-slate-500">{item.company}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="bg-[#14532d] py-16 text-white">
        <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-10">
          <div className="type-overline pb-2 text-[#68c99b]">Security</div>
          <h2 className="type-section-title not-italic text-white">Your money protected 24/7</h2>
          <p className="type-body-lg mt-4 max-w-2xl text-slate-200">Rest easy knowing your money is safe with secure storage, safeguarding, and advanced transaction monitoring.</p>
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            {securityCards.map((item) => (
              <div key={item.title} className="rounded-[20px] border border-white/10 bg-white/10 p-6">
                ...
                <p className="type-body mt-3 text-white/75">{item.body}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-10">
          <div className="type-overline pb-2 text-[#1a6b4a]">Tailored Solutions</div>
          <div className="grid gap-10 md:grid-cols-3">
            {solutionCards.map((item) => (
              <div key={item.title} className="rounded-[20px] border border-slate-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-[0_12px_40px_rgba(0,0,0,0.08)]">
                <span className="type-overline mb-4 inline-flex rounded-full bg-[#e8f5ee] px-3 py-1 text-[#1a6b4a]">{item.badge}</span>
                <h3 className="type-card-title-lg text-slate-950">{item.title}</h3>
                <p className="type-body mt-3 text-slate-600">{item.body}</p>
                <a href="#" className="type-button mt-6 inline-flex items-center gap-2 text-[#1a6b4a]">Learn more <ArrowRight className="h-4 w-4" /></a>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="bg-[#14532d] py-20 text-white">
        <div className="mx-auto flex max-w-7xl flex-col gap-8 px-6 sm:px-8 lg:flex-row lg:items-center lg:justify-between lg:px-10">
          <div>
            <h2 className="type-section-title not-italic text-white">Ready to simplify your global payments?</h2>
            <p className="type-body-lg mt-3 max-w-2xl text-slate-200">Join thousands of businesses trusting Aznix Pay for seamless cross-border transactions.</p>
          </div>
          <div className="flex flex-wrap gap-4">
            <a href="#" className="type-button inline-flex rounded-full bg-white px-6 py-3 text-[#14532d] transition hover:bg-[#e8f5ee]">Get started</a>
            <a href="#" className="type-button inline-flex rounded-full border border-white/40 px-6 py-3 text-white transition hover:border-white">Contact sales</a>
          </div>
        </div>
      </section>
    </main>
